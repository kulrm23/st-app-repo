...
if st.session_state["authentication_status"]:
    ...
    if st.button("Analyse"):
        ...
        KOTAK = get_data('KOTAKBANK.NS', interval, start_date, end_date)      
        INDUSINDBK = get_data(ticker[27], interval, start_date, end_date)

        BOB = get_data('BANKBARODA.NS', interval, start_date, end_date)
        PNB = get_data('PNB.NS', interval, start_date, end_date)
        FEDERAL = get_data('FEDERALBNK.NS', interval, start_date, end_date)
        IDFC = get_data('IDFCFIRSTB.NS', interval, start_date, end_date)
        ...
        KOTAK_maxima = cal_data(KOTAK)
        INDUSINDBK_maxima = cal_data(INDUSINDBK)
        BOB_maxima = cal_data(BOB)
        PNB_maxima = cal_data(PNB)
        FEDERAL_maxima = cal_data(FEDERAL)
        IDFC_maxima = cal_data(IDFC)
        ...
        dataframes = [ HDFCBANK_maxima,ICICIBANK_maxima,NSEBANK_maxima,AXISBANK_maxima,SBIN_maxima,KOTAK_maxima,INDUSINDBK_maxima,BOB_maxima,
                       PNB_maxima,FEDERAL_maxima,IDFC_maxima ]
        
        dataframes_weighted = [ NSEBANK_maxima,AXISBANK_maxima,HDFCBANK_maxima,ICICIBANK_maxima,SBIN_maxima,]
        ...
        merged_df['close']=NSEBANK_maxima['close']
        ...
        merged_df_weighted['close'] = NSEBANK_maxima['close']
        ...
        merged_df_index['close']=NSEBANK_maxima['close']
        ...
        merged_df_weighted_index['close']=NSEBANK_maxima['close']
