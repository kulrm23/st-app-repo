...
if st.session_state["authentication_status"]:
    ...
    strike_price= st.number_input("Enter ATM strike")
    ...
    if st.button("Analyse"):
        ...
        # df_opti = get_api_data_index_opti_v2(current_strike_price,config_icic["right"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
        ...
        historical_fut = get_api_data_index_fut_v2(config_icic["right"],config_icic["interval"],config_icic["product_type_fut"],config_icic["exchange_code"],config_icic["stock_code"],expiry_date_fut,config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")
        ...
        sp1_ce = get_api_data_index_opti_v2(strike_price-200,config_icic["right_c"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
        sp2_ce = get_api_data_index_opti_v2(strike_price-150,config_icic["right_c"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
        sp3_ce = get_api_data_index_opti_v2(strike_price-100,config_icic["right_c"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
        sp4_ce = get_api_data_index_opti_v2(strike_price-50,config_icic["right_c"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
        sp5_ce = get_api_data_index_opti_v2(strike_price+50,config_icic["right_c"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
        sp6_ce = get_api_data_index_opti_v2(strike_price+100,config_icic["right_c"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
        sp7_ce = get_api_data_index_opti_v2(strike_price+150,config_icic["right_c"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
        sp8_ce = get_api_data_index_opti_v2(strike_price+200,config_icic["right_c"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
        sp9_ce = get_api_data_index_opti_v2(strike_price+250,config_icic["right_c"],config_icic["interval"],config_icic["product_type"],config_icic["exchange_code"],config_icic["stock_code"],str(expiry_date)+"T07:00:00.000Z",config_icic["session_token"],str(start_date)+"T07:00:00.000Z",str(end_date)+"T07:00:00.000Z")       
